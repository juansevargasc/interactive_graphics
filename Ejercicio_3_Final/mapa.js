...
document.addEventListener("DOMContentLoaded", function() {
    // Inicializa el mapa y establece la vista inicial en el centro de Colombia con un nivel de zoom de 6
    ...
    // Recorre cada concesionario y agrega un marcador en el mapa
